...
class PipeDetailSerializer(PipeSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.dest_bsb_number = validated_data.get('dest_account_number', instance.dest_account_number)
        instance.dest_account_name = validated_data.get('dest_account_number', instance.dest_account_number)
        instance.dest_balance = validated_data.get('dest_account_number', instance.dest_account_number)
